...
./srcs/init_bar.c ./srcs/init_weapon.c ./srcs/create_map.c ./srcs/init_textures.c ./srcs/shots.c ./srcs/n_s_e_w.c \
./srcs/draw_weapon_and_bar.c ./srcs/make_minimap.c ./srcs/main.c
